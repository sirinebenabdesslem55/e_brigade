...
-->
  ...
  <div class="row">
    <h3>
      ...
      <?php if (isset($e->P_NOM)) echo $e->P_NOM.' '; ?>
      <?php if (isset($e->LastName)) echo $e->LastName.' '; ?>
      <?php if (isset($e->Suffix)) echo $e->Suffix; ?>
      <?php if (isset($e->P_ID)) echo ' <a href="index.php?c=employee&m=edit&id='.$e->EmployeeID.'" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Modifier l\'employé"><i class="fas fa-edit"></i> Modifier</a>';?>
    </h3>
  </div>
